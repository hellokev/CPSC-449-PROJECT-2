-- Task: Drop students administratively (e.g. if they do not show up to class)
-- Endpoint: DELETE https://localhost:5000/instructor/drop_student/?student_id={student_id}&class_code={class_code}&section_number={section_number}
